...
def city_distance_x(city):
    return city[1]
def city_distance_y(city):
    return city[2]
def partical_distance(a,b):
    return (a - b)**2
...
def closer_city(lat, lon, city_a, city_b):
    ...
    return city_a[0] if distance(center,city_a) < distance(center,city_b) else city_b[0]
